...
function ContactComponent({ id }: { id?: string }) {
    return (
        <>
            <section id={id} className="bg-black text-white py-20 px-5">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
                    <div className="bg-gray-900/20 p-4 md:p-8 rounded-2xl shadow-lg">
                        <h2 className="text-3xl font-bold mb-6 text-[#E0F600]">Contactanos!</h2>
                        ...
                        <div className="flex flex-col gap-4">
                            <a href="#" className="flex items-center gap-3 group">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="nunito text-gray-300 group-hover:text-[#E0F600] transition">+54 9 35 6450-7240</span>
                                </div>
                            </a>
                            ...
                            <a href="#" className="flex items-center gap-3 group">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="nunito text-gray-300 group-hover:text-[#E0F600] transition wrap-normal">25 de Mayo 1889, Concordia</span>
                                </div>
                            </a>
                        </div>
                    </div>
